...
API_ID = int(environ.get['API_ID', '20238319'])
API_HASH = environ.get['API_HASH', '0c5d56891ed6df7f43ecb339833755fa']
BOT_TOKEN = environ.get['BOT_TOKEN', '6144576674:AAFpKRBkwi54BEodW1X1rZ2aEd-T3H5BcT8']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2025976175').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001914792549').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001912491775').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MONGO:MONGO@mongo.ajidodn.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "MONGO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
IS_VERIFY = is_enabled((environ.get('IS_VERIFY', 'True')), True)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/howtodownloadMrMovie")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'bfF6ubToMYY0RpQ2Dq0JyWpSOal2')
...
MSG_ALRT = environ.get('MSG_ALRT', 'What Are You Looking for ?')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001914792549')).split()]
